...
DEPS = -I. -I./benchmarks -I./client/ -I./transport -I./system -I./statistics -I./blockchain -I./smart_contracts -I./data_structures -I$(JEMALLOC)/include -I$(NNMSG)/include -isystem $(BOOST) -I$(CRYPTOPP) -I./db -I$(SQLITE)/include

CFLAGS += $(DEPS) -D NOGRAPHITE=1 -Wall -Wno-sizeof-pointer-memaccess
